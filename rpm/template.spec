...
%global pkg_name rmf_building_map_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rmf-building-map-msgs
Version:        1.6.0
Release:        1%{?dist}
...
%changelog
* Fri Sep 18 2026 Morgan Quigley <mquigley@openrobotics.org> - 1.6.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Morgan Quigley <mquigley@openrobotics.org> - 1.5.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Morgan Quigley <mquigley@openrobotics.org> - 1.5.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Morgan Quigley <mquigley@openrobotics.org> - 1.5.0-1
- Autogenerated by Bloom
